...
export default function PageGone() {
  return (
    <section className="relative min-h-[80vh] flex flex-col items-center justify-center px-4 text-center overflow-hidden">
      {/* Background accents */}
      <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-gradient-violet opacity-10 blur-3xl" />
      <div className="absolute -bottom-24 -right-24 w-72 h-72 rounded-full bg-gradient-peach opacity-10 blur-3xl" />
      ...
      <div className="relative flex flex-col items-center gap-4 sm:gap-5 z-10">
        ...
        <Image
          src="/logo_white.webp"
          alt="Sad animated character for 410 page"
          width={160}
          height={160}
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="motion-preset-blur-down-md motion-delay-300 text-gray-600 text-sm sm:text-base max-w-xs sm:max-w-md">
            This page was removed for good. Here's where to find what's new instead.
          </p>
        </div>
