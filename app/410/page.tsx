...
export default function PageGone() {
  return (
    <section className="min-h-[80vh] flex flex-col items-center justify-center px-4 text-center gap-4 sm:gap-5">
      ...
      <Trash2 className="w-10 h-10 sm:w-12 sm:h-12 text-peach motion-preset-shake duration-300 motion-delay-200" />
      ...
      <p className="motion-preset-blur-down-md motion-delay-200 text-gray-600 text-sm sm:text-base max-w-xs sm:max-w-md">
        This page is gone for good — it's been permanently removed and won't be coming back.
      </p>
